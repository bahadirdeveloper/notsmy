  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center sm:p-4 pointer-events-none">
        <div
          className="w-full sm:max-w-lg bg-[#111113] border border-white/[0.08] rounded-t-3xl sm:rounded-2xl shadow-2xl shadow-black/50 animate-slide-up max-h-[92vh] overflow-y-auto pointer-events-auto"
        ...
        >
          ...
          <div className="flex items-center justify-between px-5 pt-4 sm:pt-5 pb-3">
            ...
            <button
              onClick={onClose}
              aria-label="Kapat"
              className="w-9 h-9 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center text-white/40 hover:text-white/70 hover:bg-white/[0.06] transition-all"
            >
          ...
          <div className="px-5">
            <h2
              ...
              className={[
                ...
                localNote.isCompleted ? 'line-through text-white/40' : 'text-white/95',
              ].join(' ')}
            >
              {localNote.title}
            </h2>
          ...
          {localNote.content ? (
            <div className="px-5 mt-4">
              <p className="text-white/70 text-[15px] sm:text-sm leading-relaxed whitespace-pre-wrap break-words">
                {localNote.content}
              </p>
            </div>
          ) : (
            <div className="px-5 mt-3">
              <p className="text-white/20 text-[13px] italic">Detay yok</p>
            </div>
          )}
          ...
          <div className="mt-5 px-5 pb-5 flex flex-wrap items-center gap-2">
            {localNote.type === 'task' && (
              <button
                ...
                disabled={isPending}
                className={[
                  'flex items-center gap-2 px-3.5 py-2.5 sm:py-2 rounded-lg text-[13px] sm:text-xs font-medium transition-all disabled:opacity-50',
            ...
            <button
              ...
              className="flex items-center gap-2 px-3.5 py-2.5 sm:py-2 rounded-lg text-[13px] sm:text-xs font-medium bg-white/[0.04] text-white/60 hover:bg-white/[0.08] transition-all"
            >
