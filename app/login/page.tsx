    ...
    <main className="flex min-h-screen items-center justify-center bg-[#09090b]">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-semibold text-[#10b981]">Notsmy</h1>
          <p className="mt-2 text-[#888] text-sm">Kişisel ve ekip not yönetimi</p>
        </div>

        {/* Card */}
        <div className="border border-white/10 rounded-xl p-6 bg-white/[0.03]">
          <h2 className="text-white font-medium mb-1">Giriş Yap</h2>
