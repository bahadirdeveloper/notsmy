      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="border border-white/[0.08] rounded-2xl p-6 bg-white/[0.02] backdrop-blur-sm">
          ...
          <form action={signInWithGoogle}>
            <button
              type="submit"
              className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-xl border border-white/[0.08] bg-white/[0.03] text-white/80 text-sm hover:bg-white/[0.07] hover:border-white/[0.15] transition-all mb-3 group"
            >
